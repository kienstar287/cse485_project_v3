                            ...
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav ">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-dark" href="monhoc_list.php">Môn học</a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-dark" href="thongbao_list.php">Thông báo</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link text-dark" href="tintuc_list.php">Tin tức</a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="col-lg-3">
                    ...
                    <div class="card-group">
                            ...
                            <div  class="card text-center" >
                              ...
                              <div class="card-body">
                                <a href="chitiet_mh.php?id=<?=$itemmh['id_mh']?>" class="card-title"><?=$itemmh['ten_mh']?></a>
            ...
            <div class="col-lg-3">
                    ...
                    <div class="card-group">
                            ...
                            <div  class="card text-center" >
                              ...
                              <div class="card-body">
                                <h5 class="card-title"><?=$itemtb['ten_tb']?></h5>
                                <p class="card-text"><?=$itemtb['noidung']?></p>
                                <p class="card-text"><span class="text">Người viết: <?=$itemtb['tacgia']?></span></p>
                              </div>
                            </div>
